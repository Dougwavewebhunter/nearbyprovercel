    ...
    <div className="min-h-screen grid place-items-center bg-gradient-hero p-4">
      <Card className="w-full max-w-md p-7 shadow-elegant">
        ...
        <div className="grid grid-cols-2 gap-2 mb-5">
          <Button type="button" variant="outline" onClick={() => socialLogin("google")} className="h-11">
            <Chrome className="h-4 w-4 mr-2" /> Google
          </Button>
          <Button type="button" variant="outline" onClick={() => socialLogin("facebook")} className="h-11">
            <Facebook className="h-4 w-4 mr-2" /> Facebook
          </Button>
        </div>
        <div className="relative mb-5 text-center text-xs text-muted-foreground">
          <span className="bg-card px-3 relative z-10">or continue with email</span>
